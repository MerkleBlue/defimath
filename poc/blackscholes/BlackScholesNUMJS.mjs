...
export class BlackScholesNUMJS {
  ...
  errorCorrection(x) {
    if (x < 0.35) {
      ...
      // console.log("JS: 1e9 - A              :", 1e9 - 70191.75526562665);
      // console.log("JS: 1e9 - A+B            :", 1e9 - 70191.75526562665 + 1103772.051336337 * x);
      // console.log("JS: 1e9 - A+B-C          :", 1e9 - 70191.75526562665 + 1103772.051336337 * x - 5648311.047693772 * x ** 2);
      // console.log("JS: 1e9 - A+B-C+D        :", 1e9 - 70191.75526562665 + 1103772.051336337 * x - 5648311.047693772 * x ** 2 + 12219187.046697173 * x ** 3);


      // console.log("JS: 1e9 - rest:", (1e9 - 70191.75526562665 + 1103772.051336337 * x - 5648311.047693772 * x ** 2 + 12219187.046697173 * x ** 3 - 9868497.924729755 * x ** 4));
