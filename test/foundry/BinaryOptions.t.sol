...
import {BinaryOptions} from "../../contracts/derivatives/BinaryOptions.sol";
import {Math} from "../../contracts/math/Math.sol";

/// @notice Property-based fuzz tests for BinaryOptions. Validates the binary-options
...
contract BinaryOptionsPropertyTest is Test {
