...
describe("BlackScholes", function () {
  ...
  describe("call", function () {
    ...
    describe("performance", function () {
      it("call across 5×5×3×3 strikes/times/vols/rates — 2582 gas", async function () {
        const { options } = await loadFixture(deploy);
  ...
  describe("put", function () {
    ...
    describe("performance", function () {
      it("put across 5×5×3×3 strikes/times/vols/rates — 2592 gas", async function () {
        const { options } = await loadFixture(deploy);
  ...
  describe("delta", function () {
    ...
    describe("performance", function () {
      it("delta across 5×5×3×3 strikes/times/vols/rates — 1661 gas", async function () {
        const { options } = await loadFixture(deploy);
  ...
  describe("gamma", function () {
    ...
    describe("performance", function () {
      it("gamma across 5×5×3×3 strikes/times/vols/rates — 1433 gas", async function () {
        const { options } = await loadFixture(deploy);
  ...
  describe("theta", function () {
    ...
    describe("performance", function () {
      it("theta across 5×5×3×3 strikes/times/vols/rates — 3101 gas", async function () {
        const { options } = await loadFixture(deploy);
  ...
  describe("vega", function () {
    ...
    describe("performance", function () {
      it("vega across 5×5×3×3 strikes/times/vols/rates — 1373 gas", async function () {
        const { options } = await loadFixture(deploy);
  ...
  describe("impliedVolatility", function () {
    ...
    describe("performance", function () {
      it("impliedVolatility across 5×5×3×3 strikes/times/vols/rates — 11668 gas (call) / 11743 gas (put)", async function () {
        const { options } = await loadFixture(deploy);
