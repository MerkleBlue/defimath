    ...
    function lnUpper2(uint256 x) internal pure returns (uint256 r) {
        unchecked {
            ...
            assembly {
                ...
                r := mul(fraction2, add(200000000000000000000000000000000000, r)) // 54
                r := div(mul(fraction2, add(333333333333333333333333333333333333333333333333333333, r)), 1000000000000000000000000000000000000) // 36
