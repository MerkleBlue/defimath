...
library DeFiMath {
    ...
    function lnUpper2(uint256 x) internal pure returns (uint256 r) {
        unchecked {
            ...
            // uint256 fraction8 = fraction6 * fraction2 / 1e36; // 243
            // uint256 fraction10 = fraction8 * fraction2 / 1e36; // gas 282
            // uint256 naturalLog = fraction * (1e36 + fraction2 / 3 + fraction4 / 5 + fraction6 / 7 + fraction8 / 9 + fraction10 / 11);
            // uint256 naturalLog = fraction2 / 11;
            // naturalLog = fraction2 * (0.111111111111111e36 + naturalLog) / 1e36;
            // naturalLog = fraction2 * (0.142857142857143e36 + naturalLog) / 1e36;
            ...
            assembly {
                ...
                r := mul(fraction2, add(90909090909091000000000000000000000000000000000000000, r)) // 18
                ...
                r := mul(fraction2, add(200000000000000000000000000000000000000000000000000000, r)) // 18
                r := div(r, 1000000000000000000000000000000000000000000000000000000)

                r := mul(fraction2, add(333333333333333333, r)) // 36
                r := mul(fraction, add(1000000000000000000000000000000000000, r))
                r := div(r, 500000000000000000000000000000000000)
